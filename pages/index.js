...
export default function Home() {
  ...
  return (
    <div className='m-6 space-y-4'>
      ...
      <button className='px-4 py-1 bg-slate-300 hover:bg-slate-500 flex justify-around transition-all w-50' onClick={()=>initWallet(provider)}> { walletConnectLoader ? (
                  <svg
              ...
              <h3 className="font-bold" id=""> Wallet Status: {walletConnected ? "Connected" : "Not Connected"}</h3>
              <h3 className="font-bold"> Address : {currentAccount}</h3>
